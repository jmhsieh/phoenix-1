 ...
 * you to {@link KStruct#decode(PositionedByteRange)} or
 * {@link KStruct#skip(PositionedByteRange)} over the entire {@code Struct} at
 * once.
 * </p>
 * <p>
...
public class KStructIterator implements Iterator<Object> {
   ...
   *          {@code Struct}.
   */
  public KStructIterator(PositionedByteRange src, @SuppressWarnings("rawtypes") DataType[] types) {
    this.src = src;
    this.types = types;
  }
  ...
  public int skip() {
    ...
    // TODO Read Tag and position.  If not matching, then return 0, and continue.
    return t.skip(src);
  }
}
